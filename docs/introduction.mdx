---
title: "Introduction"
description: "Welcome to OmniMind - The Open Source MCP Client Library"
sidebarTitle: "Introduction - OmniMind Docs | Open-Source MCP Client Python Library"
icon: "user-robot-xmarks"
---

<img
  className="block dark:hidden"
  src="/images/omnimind.png"
  alt="mcp_use Light Theme"
/>

<img
  className="hidden dark:block"
  src="/images/omnimind.png"
  alt="mcp_use Dark Theme"
/>
